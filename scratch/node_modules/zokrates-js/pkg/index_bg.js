...
* @returns {any}
*/
export function compile(source, location, resolve_callback, config) {
    try {
...
* @returns {any}
*/
export function compute_witness(program, abi, args) {
...
export function export_solidity_verifier(vk) {
    var ret = wasm.export_solidity_verifier(addHeapObject(vk));
    return takeObject(ret);
}
